        ...
        <div style="position: relative">
            <p class="form-row form-row-first">
                ...
                <input type="text" name="gift_card_code" class="input-text"
                       placeholder="<?php echo esc_attr( apply_filters( 'ywgc_checkout_box_placeholder', _x( 'Heb je een kortingscode?', 'Apply gift card', 'yith-woocommerce-gift-cards' ) ) ); ?>"
            ...
            <p class="form-row form-row-last">
                ...
                <button type="submit" class="button ywgc_apply_gift_card_button" name="ywgc_apply_gift_card" value="<?php echo get_option( 'ywgc_apply_gift_card_button_text' , esc_html__( 'Verzilver', 'yith-woocommerce-gift-cards' ) ); ?>"><?php echo get_option( 'ywgc_apply_gift_card_button_text' , esc_html__( 'Verzilver', 'yith-woocommerce-gift-cards' ) ); ?></button>
