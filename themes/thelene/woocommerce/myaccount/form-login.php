		...
		<div class="u-column2 col-2">
			...
			<form method="post" action="" class="woocommerce-form woocommerce-form-register register" id="mail_checker">
				...
				<p class="woocommerce-form-row form-row">
					<button type="button" class="woocommerce-Button woocommerce-button button woocommerce-form-register__submit" id="register_next" name="register" value="<?php esc_attr_e( 'doorgaan', 'woocommerce' ); ?>"><?php esc_html_e( 'doorgaan', 'woocommerce' ); ?></button>
				</p>
			</form>
